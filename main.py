...
from tkinter import messagebox, simpledialog, Label, Entry, Button, Frame
...
class FallDetectionApp:
    def __init__(self, root):
        ...
        self.root.geometry("1280x720")  # กำหนดขนาดหน้าต่างเป็น width 1280 height 720
        ...
        self.video_frame.pack(expand=True, fill=tk.BOTH)  # ปรับขนาดของเฟรมแสดงวิดีโอให้พอดีกับหน้าต่าง
